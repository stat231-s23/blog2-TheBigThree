...
```{r table-app, out.width = "100%", out.extra = 'data-external="1" frameborder="no"', fig.cap = "[Data Science Salaries Shiny App](https://michaelp.shinyapps.io/table/)"}
...
```{r network-app, out.width = "100%", out.extra = 'data-external="1" frameborder="no"', fig.cap = "[Data Science Salaries Shiny App](https://michaelp.shinyapps.io/networkGraph/)"}
