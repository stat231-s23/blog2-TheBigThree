...
In this case, the network graph shows a pretty dominant Manchester City Team as all the arrows show a positive goal difference, except two which show a neutral goal difference. Hence, Manchester City does not have a negative goal difference against any other premier league team. 
...
Finally, Arsenal had negative goal differences against five teams: Manchester City, Manchester United, Liverpool, Chelsea, and Brighton and Hove Albion.
