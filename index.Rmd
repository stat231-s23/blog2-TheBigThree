...
```{r ds-salaries-app, out.width = "100%", out.extra = 'data-external="1" frameborder="no"', fig.cap = "[Data Science Salaries Shiny App](https://michaelp.shinyapps.io/table/)"}
...
```{r ds-salaries-app, out.width = "100%", out.extra = 'data-external="1" frameborder="no"', fig.cap = "[Data Science Salaries Shiny App](https://michaelp.shinyapps.io/networkGraph/)"}
...
include text here about his data....

### cluster 2

knitr::include_graphics("path/to/image3.jpg")
